                    ...
                    <div className={styles.svgWrap}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="13.594" height="13.262" viewBox="0 0 13.594 13.262">
                            <g id="Group_130" data-name="Group 130" transform="translate(-209.154 -539.125)">
                                <path id="Path_114" data-name="Path 114" d="M-23615.367-18173.264l4.863,4.863-4.863,4.861" transform="translate(23832 18714.158)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"/>
